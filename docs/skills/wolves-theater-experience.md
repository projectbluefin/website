...
3. **Integrated Cover Page Navigation:** The comic book cover (Page 1) is a fully integrated, standard part of the Track 0 theater presentation. Navigation controls, keyboard bindings, and dropdown jumpers must allow the user to freely navigate back to Page 1 and step backwards. Playlist completion stops naturally rather than looping.
