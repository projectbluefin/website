...
//
// Labels are the depicted species' scientific name from
// `wolves-dinosaur-species.ts` (or the genus alone when no epithet is
// recorded there or in the source filename). The label describes the animal,
// not the file, so duplicate labels across poses are expected. Ids stay
// unique and pose-derived; tests and harnesses pin them.
export const wolvesComicHeroShots = [
  {
    id: 'youre-holding-it-wrong-post1',
    src: 'characters/Youre_Holding_It_Wrong_Post1.webp',
    label: 'Deinonychus antirrhopus',
  ...
  },
  {
    ...
    label: 'Kentrosaurus aethiopicus',
