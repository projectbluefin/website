...
const seagerFile = 'src/data/lore/sidebar-quote-john-seager.md';
const newSeagerFile = 'src/data/lore/sidebar-comm-john-seager-18.md';

let content = fs.readFileSync(seagerFile, 'utf8');

// The new content we want with proper formatting
const newContent = `---
...
fs.writeFileSync(newSeagerFile, newContent);
fs.unlinkSync(seagerFile);

console.log('Converted John Seager to a communication');
